...
public static class ImmutableArrayExtensions
{
    ...
    public static bool HasDuplicates<T>(this ImmutableArray<T> array)
    {
        switch (array.Length)
        {
            case 0:
    ...
    public static void AddToMultiValueDictionaryBuilder<K, T>(Dictionary<K, object> accumulator, K key, T item)
        where K : notnull
        where T : notnull
    {
    ...
    public static void CreateNameToMembersMap<TKey, TNamespaceOrTypeSymbol, TNamedTypeSymbol, TNamespaceSymbol>
...
#pragma warning restore IDE0303 // Simplify collection initialization
    ...
    public static Dictionary<TKey, ImmutableArray<TNamedTypeSymbol>> GetTypesFromMemberMap<TKey, TNamespaceOrTypeSymbol, TNamedTypeSymbol>
    ...
    public static bool IsSorted<T>(this ImmutableArray<T> array, IComparer<T>? comparer = null)
    {
    ...
    public static int BinarySearch<TElement, TValue>(this ReadOnlySpan<TElement> array, TValue value, Func<TElement, TValue, int> comparer)
    {
        var low = 0;
