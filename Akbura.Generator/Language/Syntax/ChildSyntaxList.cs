...
internal readonly partial struct ChildSyntaxList : IEquatable<ChildSyntaxList>, IReadOnlyList<SyntaxNodeOrToken>
{
    ...
    public ChildSyntaxList(AkburaSyntax node)
    {
        _node = node;
    ...
    public readonly struct SlotData
    {
        ...
        public SlotData(AkburaSyntax node)
    ...
    public static SyntaxNodeOrToken ItemInternal(AkburaSyntax node, int index)
    {
    ...
    /// <summary>
    /// public indexer that does not verify index.
    /// Used when caller has already ensured that index is within bounds.
    /// </summary>
    public static SyntaxNodeOrToken ItemInternal(AkburaSyntax node, int index, ref SlotData slotData)
    {
    ...
    /// </remarks>
    public static SyntaxNodeOrToken ChildThatContainsPosition(AkburaSyntax node, int targetPosition)
    {
    ...
    /// Used when caller has already ensured that index is within bounds.
    /// </summary>
    public static AkburaSyntax? ItemInternalAsNode(AkburaSyntax node, int index, ref SlotData slotData)
    {
        GreenNode? greenChild;
        var green = node.Green;
        var idx = index - slotData.PrecedingOccupantSlotCount;
