...
where XxxSyntax is the corresponding RED node type (e.g., AkburaDocumentSyntax, MarkupExtensionSyntax, StateInitializerSyntax, SimpleStateInitializerSyntax, etc.).
