...
internal sealed class TextKeyedCache<T> where T : class
{
    ...
    internal T? FindItem(ReadOnlySpan<char> chars, int hashCode)
    {
        ...
        var e = FindSharedEntry(chars, hashCode);
        if (e != null)
        {
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
        ...
        Justification = "Used in Akbura compiler internals, not in analyzer execution context; deterministic behavior is not required.")]
