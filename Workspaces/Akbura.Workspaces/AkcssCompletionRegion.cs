...
internal enum AkcssCompletionRegionKind
{
    StandaloneDocument,
    InlineBlock,
}

internal readonly struct AkcssCompletionRegion
{
    private AkcssCompletionRegion(
        AkcssCompletionRegionKind kind,
        AkburaSyntax root,
    ...
    public AkcssCompletionRegionKind Kind { get; }
        ...
        out AkcssCompletionRegion region)
    {
        ...
        if (root is AkcssDocumentSyntax akcssDocument)
        {
            ...
            region = new AkcssCompletionRegion(
                AkcssCompletionRegionKind.StandaloneDocument,
                akcssDocument,
                membersSpan,
        ...
        var inlineMembersSpan = TextSpan.FromBounds(
            ...
            membersEnd);
        region = new AkcssCompletionRegion(
            AkcssCompletionRegionKind.InlineBlock,
            inlineBlock,
            inlineMembersSpan,
            GetImportInsertionPosition(
                inlineBlock.Members,
