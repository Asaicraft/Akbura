...
partial class AkburaSyntax
{
    private IEnumerable<AkburaSyntax> DescendantNodesImpl(TextSpan span, Func<AkburaSyntax, bool>? descendIntoChildren, bool descendIntoTrivia, bool includeSelf)
    {
    ...
    private IEnumerable<SyntaxNodeOrToken> DescendantNodesAndTokensImpl(TextSpan span, Func<AkburaSyntax, bool>? descendIntoChildren, bool descendIntoTrivia, bool includeSelf)
    {
        return descendIntoTrivia
    ...
    private IEnumerable<SyntaxTrivia> DescendantTriviaImpl(TextSpan span, Func<AkburaSyntax, bool>? descendIntoChildren = null, bool descendIntoTrivia = false)
    {
        return descendIntoTrivia
    ...
    private struct ChildSyntaxListEnumeratorStack : IDisposable
    {
        ...
        public ChildSyntaxListEnumeratorStack(AkburaSyntax startingNode, Func<AkburaSyntax, bool>? descendIntoChildren)
        {
        ...
        public void PushChildren(AkburaSyntax node, Func<AkburaSyntax, bool>? descendIntoChildren)
        {
    ...
    private struct TwoEnumeratorListStack : IDisposable
    {
        ...
        public TwoEnumeratorListStack(AkburaSyntax startingNode, Func<AkburaSyntax, bool>? descendIntoChildren)
        {
        ...
        public readonly bool IsNotEmpty => _discriminatorStack?.Count > 0;
    ...
    private struct ThreeEnumeratorListStack : IDisposable
    {
        ...
        public ThreeEnumeratorListStack(AkburaSyntax startingNode, Func<AkburaSyntax, bool>? descendIntoChildren)
        {
            _nodeStack = new ChildSyntaxListEnumeratorStack(startingNode, descendIntoChildren);
            _triviaStack = new TriviaListEnumeratorStack();
            if (_nodeStack.IsNotEmpty)
    ...
    private IEnumerable<AkburaSyntax> DescendantNodesOnly(TextSpan span, Func<AkburaSyntax, bool>? descendIntoChildren, bool includeSelf)
    {
    ...
    private IEnumerable<SyntaxNodeOrToken> DescendantNodesAndTokensOnly(TextSpan span, Func<AkburaSyntax, bool>? descendIntoChildren, bool includeSelf)
    {
        if (includeSelf && IsInSpan(in span, FullSpan))
        {
            yield return this;
    ...
    private IEnumerable<SyntaxNodeOrToken> DescendantNodesAndTokensIntoTrivia(TextSpan span, Func<AkburaSyntax, bool>? descendIntoChildren, bool includeSelf)
    {
        if (includeSelf && IsInSpan(in span, FullSpan))
        {
            yield return this;
    ...
    private IEnumerable<SyntaxTrivia> DescendantTriviaOnly(TextSpan span, Func<AkburaSyntax, bool>? descendIntoChildren)
    {
        using var stack = new ChildSyntaxListEnumeratorStack(this, descendIntoChildren);
    ...
    private IEnumerable<SyntaxTrivia> DescendantTriviaIntoTrivia(TextSpan span, Func<AkburaSyntax, bool>? descendIntoChildren)
    {
