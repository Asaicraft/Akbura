...
public sealed class AkburaGenerationCatalogTests
{
    ...
    public void ModuleWriter_WritesCompilableModuleMetadata()
    {
        ...
        try
        {
            ...
            var writer = new AkcssModuleWriter(codeWriter);
            ...
            codeWriter.WriteLine("private sealed class Style_0 : global::Akbura.Akcss.AkcssStyle");
            codeWriter.WriteLine("{");
            codeWriter.WriteLine("}");
            codeWriter.WriteLine();

            codeWriter.WriteLine("private sealed class Style_1 : global::Akbura.Akcss.AkcssStyle");
            codeWriter.WriteLine("{");
            codeWriter.WriteLine("}");
